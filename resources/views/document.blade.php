        ...
        <div class="grid grid-cols-1 gap-3 mt-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="mb-3 xl:w-full">
                ...
                <select name="type" id="type"
                    class="select select-bordered bg-white border-slate-400 text-lg font-medium w-full">
            ...
            <div class="mb-3 xl:w-full">
                ...
                <select name="unitInner" id="unitInner"
                    class="select select-bordered font-medium bg-white border-slate-400 text-lg w-full disabled:bg-gray-300"
                    disabled>
                ...
                <div class="form-control xl:w-full col-span-4">
                    ...
                    <div class="grid lg:grid-cols-12 grid-cols-5 gap-4">
                        <select name="startMonth" id="startMonth"
                            ...
                            <option value="{{$month->id}}" {{ (old("startMonth")==$month->id ? "selected": "") }}>
                                {{$month->name_th}} </option>
                            @endforeach
                        </select>
                        ...
                        <select name="endMonth" id="endMonth"
                            class="select select-error bg-white col-span-2 text-lg font-medium disabled:bg-gray-300"
                            disabled>
                            <option value="" selected>เดือน</option>
                            @foreach ($monthsSelectionForm as $month)
                            <option value="{{$month->id}}" {{ (old("endMonth")==$month->id ? "selected": "") }}>
                                {{$month->name_th}} </option>
                            @endforeach
                        </select>
                        ...
                        <button type="submit" id="submitDoc"
                            class="text-white bg-teal-600 hover:bg-teal-700 rounded-md text-lg font-medium">ค้นหา</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="p-3 text-base text-gray-700 align-text-top">
                            <a href="{{$result->titledescription}}" target="_blank"
                                class=" font-normal text-blue-500 hover:text-rose-600">{{$result->regtitle}}</a>
                        </td>
                        <td class="p-3 text-base text-gray-700 whitespace-nowrap align-text-top">
                            @if ($result->regtype == null )
                            <span
                                class="p-1.5 uppercase tracking-wider text-slate-800 bg-slate-200 rounded-lg bg-opacity-50">ไม่ระบุ</span>
                            @else
                            @if ($result->type['typeid'] == 0 )
                            <span
                                class="p-1.5 uppercase tracking-wider text-green-800 bg-green-200 rounded-lg bg-opacity-50">{{$result->type['typename']}}</span>
                            @elseif ($result->type['typeid'] == 3 )
                            <span
                                class="p-1.5 uppercase tracking-wider text-red-800 bg-red-200 rounded-lg  bg-opacity-50">{{$result->type['typename']}}</span>
                            @else
                            <span
                                class="p-1.5 uppercase tracking-wider text-yellow-800 bg-yellow-200 rounded-lg bg-opacity-50">อื่น
                                ๆ</span>
                            @endif
                            @endif
                        </td>
                        ...
                        <td class="p-3 text-base text-gray-700 whitespace-nowrap align-text-top">
                            ...
                            <a href="{{$result->regdoc_url}}" target="_blank" class="grid justify-items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-red-500 "
                                    viewBox="0 0 384 512">
                                    <path
                                ...
                                @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'docx' ||
                                pathinfo($result->regdoc,PATHINFO_EXTENSION) == 'doc')
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-blue-500"
                                    viewBox="0 0 384 512">
                                ...
                                @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'xlsx' ||
                                pathinfo($result->regdoc,PATHINFO_EXTENSION) == 'xls' )
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-green-600"
                                    viewBox="0 0 384 512">
                                    <path
                                ...
                                @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'zip' ||
                                pathinfo($result->regdoc,PATHINFO_EXTENSION) == 'rar' )
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-orange-400"
                                    viewBox="0 0 384 512">
                                    <path
                                ...
                                @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'png' ||
                                pathinfo($result->regdoc,PATHINFO_EXTENSION) == 'jpg' )
                                ...
                                @else
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-slate-700"
                                    viewBox="0 0 384 512">
                                    <path
                        ...
                        <td class="p-3 text-base text-gray-700 whitespace-nowrap align-text-top">
                            ...
                            <a href="{{$result->regdoc2_url}}" target="_blank" class="grid justify-items-center">
                                ...
                                @elseif (pathinfo($result->regdoc2, PATHINFO_EXTENSION) == 'docx' ||
                                pathinfo($result->regdoc2,PATHINFO_EXTENSION) == 'doc')
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-blue-500"
                                    viewBox="0 0 384 512">
                                    <path d="M365.3 93.38l-74.63-74.64C278.6 6.742 262.3 0 245.4 0H64C28.65 0 0 28.65 0 64l.0065 384c0 35.34 28.65 64 64
                                             64H320c35.2 0 64-28.8 64-64V138.6C384 121.7 377.3 105.4 365.3 93.38zM336 448c0 8.836-7.164 16-16 16H64.02c-8.838
                                ...
                                @elseif (pathinfo($result->regdoc2, PATHINFO_EXTENSION) == 'xlsx' ||
                                pathinfo($result->regdoc2,PATHINFO_EXTENSION) == 'xls' )
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-green-600"
                                    viewBox="0 0 384 512">
                                    <path
                                        d="M365.3 93.38l-74.63-74.64C278.6 6.742 262.3 0 245.4 0H64C28.65 0 0 28.65 0 64l.0065 384c0 35.34 28.65 64 64 64H320c35.2 0 64-28.8 64-64V138.6C384 121.7 377.3 105.4 365.3 93.38zM336 448c0 8.836-7.164 16-16 16H64.02c-8.838 0-16-7.164-16-16L48 64.13c0-8.836 7.164-16 16-16h160L224 128c0 17.67 14.33 32 32 32h79.1V448zM229.1 233.3L192 280.9L154.9 233.3C146.8 222.8 131.8 220.9 121.3 229.1C110.8 237.2 108.9 252.3 117.1 262.8L161.6 320l-44.53 57.25c-8.156 10.47-6.25 25.56 4.188 33.69C125.7 414.3 130.8 416 135.1 416c7.156 0 14.25-3.188 18.97-9.25L192 359.1l37.06 47.65C233.8 412.8 240.9 416 248 416c5.125 0 10.31-1.656 14.72-5.062c10.44-8.125 12.34-23.22 4.188-33.69L222.4 320l44.53-57.25c8.156-10.47 6.25-25.56-4.188-33.69C252.2 220.9 237.2 222.8 229.1 233.3z" />
                                </svg>
                                @elseif (pathinfo($result->regdoc2, PATHINFO_EXTENSION) == 'zip' ||
                                pathinfo($result->regdoc2,PATHINFO_EXTENSION) == 'rar' )
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-orange-400"
                                    viewBox="0 0 384 512">
                                    <path
                                        d="M256 0v128h128L256 0zM224 128L224 0H48C21.49 0 0 21.49 0 48v416C0 490.5 21.49 512 48 512h288c26.51 0 48-21.49 48-48V160h-127.1C238.3 160 224 145.7 224 128zM96 32h64v32H96V32zM96 96h64v32H96V96zM96 160h64v32H96V160zM128.3 415.1c-40.56 0-70.76-36.45-62.83-75.45L96 224h64l30.94 116.9C198.7 379.7 168.5 415.1 128.3 415.1zM144 336h-32C103.2 336 96 343.2 96 352s7.164 16 16 16h32C152.8 368 160 360.8 160 352S152.8 336 144 336z" />
                                </svg>
                                @elseif (pathinfo($result->regdoc2, PATHINFO_EXTENSION) == 'png' ||
                                pathinfo($result->regdoc2,PATHINFO_EXTENSION) == 'jpg' )
                                <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-sky-400" viewBox="0 0 384 512">
                                    <path
                                        d="M224 128L224 0H48C21.49 0 0 21.49 0 48v416C0 490.5 21.49 512 48 512h288c26.51 0 48-21.49 48-48V160h-127.1C238.3 160 224 145.7 224 128zM96 224c17.67 0 32 14.33 32 32S113.7 288 96 288S64 273.7 64 256S78.33 224 96 224zM318.1 439.5C315.3 444.8 309.9 448 304 448h-224c-5.9 0-11.32-3.248-14.11-8.451c-2.783-5.201-2.479-11.52 .7949-16.42l53.33-80C122.1 338.7 127.1 336 133.3 336s10.35 2.674 13.31 7.125L160 363.2l45.35-68.03C208.3 290.7 213.3 288 218.7 288s10.35 2.674 13.31 7.125l85.33 128C320.6 428 320.9 434.3 318.1 439.5zM256 0v128h128L256 0z" />
                                </svg>
                ...
                <div class="flex text-base text-gray-700 pt-10">
                    <div class="absolute left-3 bottom-3 min-h-max max-h-full ">
                        ...
                        <a href="{{$result->regdoc_url}}" target=" _blank" class="grid justify-items-center">
                            ...
                            @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'zip' || pathinfo($result->regdoc,
                            PATHINFO_EXTENSION) == 'rar' )
                            <svg xmlns="http://www.w3.org/2000/svg" class=" w-8 fill-orange-400" viewBox="0 0 384 512">
                                <path
                                    d="M256 0v128h128L256 0zM224 128L224 0H48C21.49 0 0 21.49 0 48v416C0 490.5 21.49 512 48 512h288c26.51 0 48-21.49 48-48V160h-127.1C238.3 160 224 145.7 224 128zM96 32h64v32H96V32zM96 96h64v32H96V96zM96 160h64v32H96V160zM128.3 415.1c-40.56 0-70.76-36.45-62.83-75.45L96 224h64l30.94 116.9C198.7 379.7 168.5 415.1 128.3 415.1zM144 336h-32C103.2 336 96 343.2 96 352s7.164 16 16 16h32C152.8 368 160 360.8 160 352S152.8 336 144 336z" />
                            </svg>
                            @elseif (pathinfo($result->regdoc, PATHINFO_EXTENSION) == 'png' || pathinfo($result->regdoc,
