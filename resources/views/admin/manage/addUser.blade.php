   ...
   <section class="input">
      <section class="user1">
         <div class="form-control w-full">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" pattern="[0-9]+" minlength="8" maxlength="8" name="sapid1" id="sapid1" value="{{old('sapid1')}}" required class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
         ...
         <div class="form-control w-full max-w-xs">
            ...
            <div class="flex">
               ...
               <div class="flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg"  weight="40" height="40" viewBox="0 0 24 24" name="plus_icon" id="plus_icon">
                     <path fill="#0092E4" d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H13V8a1,1,0,0,0-2,0v3H8a1,1,0,0,0,0,2h3v3a1,1,0,0,0,2,0V13h3a1,1,0,0,0,0-2Z"/>
                  </svg>
               </div>
            </div>
