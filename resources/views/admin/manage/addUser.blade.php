   ...
   <section id="inputform" class="grid grid-cols-1 lg:grid-cols-2 gap4">
      <section id="user1" class="grid grid-cols-1 lg:grid-cols-2 gap4">
          <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid1" id="sapid1"
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission1" id="permission1" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
            ...
            <div class="alert alert-error shadow-lg">
               <div>
                 ...
                 <span>{{ $errors->first('massage1') }}</span>
               </div>
             </div>
            @endif
          </div>
      ...
      <section id="user2" class="grid grid-cols-1 lg:grid-cols-2 gap4 hidden">
         <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid2" id="sapid2"
            class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission2" id="permission2" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
              <option value="" selected>---- เลือกสิทธิ์ผู้ใช้งาน ----</option>
              <option value="1">ผู้ดูแลระบบ</option>
              <option value="0">ผู้ใช้งานทั่วไป</option>
            </select>
      ...
      <section id="user3" class="grid grid-cols-1 lg:grid-cols-2 gap4 hidden">
         <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid3" id="sapid3"
            class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission3" id="permission3" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
              <option value="" selected>---- เลือกสิทธิ์ผู้ใช้งาน ----</option>
              <option value="1">ผู้ดูแลระบบ</option>
              <option value="0">ผู้ใช้งานทั่วไป</option>
            </select>
      ...
      <section id="user4" class="grid grid-cols-1 lg:grid-cols-2 gap4 hidden">
         <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid4" id="sapid4"
            class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission4" id="permission4" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
              <option value="" selected>---- เลือกสิทธิ์ผู้ใช้งาน ----</option>
              <option value="1">ผู้ดูแลระบบ</option>
              <option value="0">ผู้ใช้งานทั่วไป</option>
            </select>
      ...
      <section id="user5" class="grid grid-cols-1 lg:grid-cols-2 gap4 hidden">
         <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid5" id="sapid5"
            class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission5" id="permission5" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
              <option value="" selected>---- เลือกสิทธิ์ผู้ใช้งาน ----</option>
              <option value="1">ผู้ดูแลระบบ</option>
              <option value="0">ผู้ใช้งานทั่วไป</option>
            </select>
      ...
      <section id="user6" class="grid grid-cols-1 lg:grid-cols-2 gap4 hidden">
         <div class="form-control w-full max-w-xs">
            ...
            <input type="text" placeholder="กรอกรหัสพนักงาน" name="sapid6" id="sapid6"
            class="input input-bordered w-full max-w-xs bg-white border-slate-400 text-lg font-medium" />
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <select name="permission6" id="permission6" class="select select-bordered bg-white border-slate-400 text-lg font-normal">
              <option value="" selected>---- เลือกสิทธิ์ผู้ใช้งาน ----</option>
              <option value="1">ผู้ดูแลระบบ</option>
              <option value="0">ผู้ใช้งานทั่วไป</option>
            </select>
