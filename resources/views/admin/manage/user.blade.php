      ...
      <div class="modal-box w-8/12 max-w-3xl relative bg-white">
         <form action="{{route('manage.store')}}" method="post">
            ...
            <p class="py-4 flex flex-col w-full lg:grid lg:grid-cols-2 gap4">
               ...
               <section id="user" class="sm:flex sm:flex-col md:grid md:grid-cols-5 lg:grid lg:grid-cols-5 gap4">
                  <div class="col-span-2">
                     <div class="form-control w-full pr-4">
                        ...
                        <input type="text" placeholder="99999999" pattern="[0-9]+" minlength="8" maxlength="8" name="sapid" id="sapid" 
                        value="{{old('sapid')}}" required 
                  ...
                  <div class="form-control w-full max-w-xs">
                     <div class="flex flex-col">
                        ...
                        <div class="flex flex-row">
                           ...
                           <select disabled required name="permission" id="permission" class="col-span-2 select select-bordered disabled:bg-slate-200 bg-white border-slate-400 text-lg font-normal">
                  ...
                  <div class="col-span-2 mt-2">
                     <input type="text" id="username" class="input input-bordered w-full max-w-xs disabled:bg-white 
