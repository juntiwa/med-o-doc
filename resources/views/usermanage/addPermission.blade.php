   ...
   <div id="InputGroup" class="grid grid-cols-1 gap-4 ">
      <div id="InputDiv1" class="flex justify-start">
         <div class="mb-3 xl:w-96 pr-5">
            ...
            <input required type="text" name="username" id="username1" placeholder="กรอกชื่อ . นามสกุล 3 ตัว" class=" form-control block w-full px-3  py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" value="">
         </div>
   ...
   $(document).ready(function() {
      ...
      $("#addButton").click(function() {
         ...
         newInputDiv.after().html('<div class="mb-3 xl:w-96 pr-5">' +
            ...
            '" placeholder="กรอกชื่อ . นามสกุล 3 ตัว" class=" form-control block w-full px-3  py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" value="">' +
            '</div>' +
            '<div class="mb-3 xl:w-96 pl-5">' +
