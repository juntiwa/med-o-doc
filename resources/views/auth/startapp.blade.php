      ...
      @csrf
       ...
       <div class="grid grid-cols-2 gap-4">
         <div>
            ...
            focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5" placeholder="รหัสพนักงาน" required>
        </div>
         <div>
            <label for="login" class="block mb-2 text-base font-medium text-gray-900">ชื่อผู้ใช้งาน <span class="text-rose-600">*</span></label>
            <input type="text" name="login" id="login" class="bg-white border border-gray-300 text-gray-900 text-base rounded-lg 
            focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5" placeholder="ชื่อผู้ใช้งาน" required>
      </div>
       </div>
       <div>
           ...
           focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5" placeholder="ชื่อ นามสกุล" required>
       </div>
       <div>
