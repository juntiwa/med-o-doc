            ...
            <div class="w-full mt-16 md:mt-0 md:w-2/5">
                <form action="{{ route('login.authenticate') }}" method="POST">
                    ...
                    <div class="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 shadow-2xl px-7 rounded
                        ...
                        <h3 class="mb-6 text-base text-teal-700 font-medium text-center leading-loose">Login ด้วย Siriraj AD ใช้ Username และ Password เดียวกับระบบ e-Document</h3>
                        @error('message')
