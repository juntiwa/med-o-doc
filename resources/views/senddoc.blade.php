...
<div class="grid grid-rows-1 pb-3 space-y-4 border-b lg:items-center lg:space-y-0 lg:flex-row">
   <div class="lg:flex lg:justify-between md:flex md:justify-between md:space-x-3 sm:grid sm:grid-cols-1 mt-3">
      <!-- หัวข้อหน้าเว็บ -->
      <h1 class="text-2xl font-semibold whitespace-normal">ทะเบียนหนังสือส่ง</h1>
      ...
      <tbody class="divide-y divide-gray-100">
         ...
         <tr class="bg-white">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               <a href="/open-files/{{substr($send->regdoc, 0, -21)}}/{{ explode('.', $send->regdoc)[1] }}/{{ explode('.', $send->regdoc)[0] }}" target=" _blank" class="grid justify-items-center">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               @else
               <a href="/open-files/{{substr($send->regdoc2, 0, -21)}}/{{ explode('.', $send->regdoc2)[1] }}/{{ explode('.', $send->regdoc2)[0] }}" target=" _blank" class="grid justify-items-center">
