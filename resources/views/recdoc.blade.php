      ...
      <tbody class="divide-y divide-gray-100">
         ...
         <tr class="bg-white">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               @else
               <a href="/open-files/{{substr($rec->regdoc, 0, -21)}}/{{ explode('.', $rec->regdoc)[1] }}/{{ explode('.', $rec->regdoc)[0] }}" target=" _blank" class="grid justify-items-center">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               @else
               <a href="/open-files/{{substr($rec->regdoc2, 0, -21)}}/{{ explode('.', $rec->regdoc2)[1] }}/{{ explode('.', $rec->regdoc2)[0] }}" target=" _blank" class="grid justify-items-center">
