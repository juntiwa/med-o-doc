      ...
      <tbody class="divide-y divide-gray-100 items-start">
         ...
         <tr class="bg-white">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               <a href="/open-files/{{substr($reg->regdoc, 0, 4)}}/{{$reg->regrecid}}" target=" _blank" class="grid justify-items-center">
            ...
            <td class="p-3 text-base text-gray-800 font-medium">
               ...
               @else
               <a href="/open-files2/{{substr($reg->regdoc, 0, 4)}}/{{$reg->regrecid}}" target=" _blank" class="grid justify-items-center">
