...
class AdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $log_activity->action = Auth::user()->username.' เข้าสู่หน้า activity log';
        $dt = Carbon::now();
    ...
    public function permis(Request $request)
    {
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' เข้าสู่หน้าข้อมูลสิทธิ์ผู้ใช้งาน';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
    ...
    public function add(Request $request)
    {
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' เข้าสู่หน้าเพิ่มข้อมูลสิทธิ์ผู้ใช้งาน';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
    ...
    public function create(Request $request)
    {
        ...
        if ($users === null) {
            ...
            $log_activity->user_agent = $request->header('user-agent');
            $log_activity->action = Auth::user()->username.' เพิ่มข้อมูลสิทธิ์ผู้ใช้งาน'.$datas;
            $dt = Carbon::now();
            $log_activity->date_time = date('d-m-Y H:i:s');
            $log_activity->save();
    ...
    public function edit(Request $request, $id)
    {
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' เข้าสู่หน้าแก้ไขสิทธิ์ผู้ใช้งาน';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' แก้ไขสิทธิ์ผู้ใช้งาน';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
    ...
    public function deleteActivity(Request $request)
    {
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' ลบข้อมูล activity log';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
    ...
    public function export(Request $request)
    {
        ...
        $filename = 'Log_MED_O_Doc'.$time_now.'.xlsx';
        ...
        $log_activity->user_agent = $request->header('user-agent');
        $log_activity->action = Auth::user()->username.' export ข้อมูล activity log';
        $dt = Carbon::now();
        $log_activity->date_time = date('d-m-Y H:i:s');
        $log_activity->save();
